...
const renderItem = ({ item }) => (
  <View style={{margin:5,borderWidth:1,borderColor:'#1d7488',borderRadius:10,overflow:'hidden'}}>
    <Text style={{textAlign:'center',fontSize:16,borderBottomColor:'#1d7488',borderBottomWidth:1,padding:5,color:'#fff',backgroundColor:'#1d7488'}}>{item.title}</Text>
    <View style={{margin:5}}>
    ...
    <SafeAreaView >
      ...
      <View style={{display:'flex',flexDirection:'row-reverse'}}>
        ...
        >
          ...
          <Icon type='FontAwesome' name='filter' style={{fontSize:16,marginHorizontal:3}}/>
        </TouchableOpacity>
        <TouchableOpacity
        onPress={()=>{setShowAll(false);setSortBy(null)}}
          style={{
            display:'flex',
            flexDirection:'row-reverse',
            margin:8,
        ...
        >
          <Text>Show All</Text>
          <Icon type='FontAwesome5' name='sort' style={{fontSize:16,marginHorizontal:3}}/>
        </TouchableOpacity>
      </View>
      <View >
      <FlatList
